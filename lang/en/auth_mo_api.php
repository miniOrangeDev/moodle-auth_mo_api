...
$string['mo_api_url_desc'] = 'Copy the default url';
$string['mo_api_key_desc'] = 'Copy the API key';
$string['mo_api_authn_para_desc'] = 'Copy the parameters';
$string['mo_api_attributes'] = 'Attribute Release Statements';
$string['mo_api_username'] = 'Username:';
$string['mo_api_username_desc'] = 'Enter Username';
$string['mo_api_fname'] = 'First Name:';
$string['mo_api_fname_desc'] = 'Enter first name';
$string['mo_api_lname'] = 'Last Name:';
$string['mo_api_lname_desc'] = 'Enter last name';
$string['mo_api_email'] = 'Email:';
$string['mo_api_email_desc'] = 'Enter your email id';
